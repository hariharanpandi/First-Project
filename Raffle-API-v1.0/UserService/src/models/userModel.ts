...
export const findOneUser = (dynamicFields: FilterQuery<UserDocument>) => User.findOne(dynamicFields);

export const findByIdAndUpdateUser = (filter: FilterQuery<UserDocument>, updatedValue: Partial<UserDocument>) => User.findByIdAndUpdate(filter, updatedValue, { new: true });