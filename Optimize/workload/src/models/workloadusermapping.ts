...
export const workloadBulkWrite = (values: any) => WorkloadUser.bulkWrite(values);

export const findOneWorkloadUserMap = (dynamicFields: Record<string, any>) => WorkloadUser.findOne(dynamicFields);
